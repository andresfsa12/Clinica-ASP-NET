        ...
        <asp:DataList ID="dlAtencionMedica" runat="server" CssClass="table table-striped" RepeatColumns="1" OnItemCommand="dlAtencionMedica_ItemCommand">
            <ItemTemplate>
                <table>
                    <tr>
                        <td rowspan="2">
                            <asp:Image ID="imgPaciente" runat="server" Height="200px" Width="200px" ImageUrl="~/img/avatar5.png" AlternateText="Imagen del Paciente" CssClass="img-thumbnail" />
                        </td>
                        <td>
                            ...
                            <strong>&nbsp;&nbsp;Sexo:</strong>
                            <asp:Label ID="lblSexo" runat="server" Text='<%#(Eval("Paciente.Sexo").ToString() == "M" ? "Masculino" : "Femenino") %>'></asp:Label><br />
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;&nbsp;<asp:Button ID="btnAtencion" runat="server" CssClass="btn btn-primary" Text="Realizar Atención" CommandName="Registrar" /></td>
                        <td>&nbsp;&nbsp;<asp:Button ID="btnCancelar" runat="server" CssClass="btn btn-danger" Text="Cancelar" CommandName="Cancelar" OnClientClick="return confirm('¿Está seguro que desea cancelar la Cita?')" /></td>
                    </tr>
                    <tr>
                        <td>
